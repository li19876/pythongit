...
def get(keyword,page):
    headers = {
        ...
        'Host': 'ip.tianyancha.com',
        'Upgrade-Insecure-Requests': '1',
        'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36'
    }
    url ='https://ip.tianyancha.com/search/page.html?keywords={}&scope=0&pn={}&ps=30&openCls1Filter=false&openStatusFilter=false&openAppYearFilter=false&match=0%2C1%2C2%2C3%2C4%2C5%2C6%2C7%2C8%2C9&_=1577428170708'.format(keyword,page)
