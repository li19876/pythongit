    ...
    if isinstance(response,int):
        ...
        for gs in lxlist:
            ...
            if email2:
                ...
                email = email1
            res = {"phone": phone, "gsname": gsname, "frname": frname, "city": city, "email": email,"zczb":zczb[0] if zczb != [] else "","buildtime":buildtime[0] if buildtime!= [] else "","qyzt":qyzt,"jyfw":jyfw}
            # print(res)
            if phone != "":
                result.append(res)
        print("解析成功")
